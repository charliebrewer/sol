...
SolGame.views = {
	...
	updateNavigationView : function(delta) {
		...
		/*
		//SolGame.views.curvePos.drawCircle(
			SolGame.views.getRenderedPosition(curCurvePos.x, true),
			SolGame.views.getRenderedPosition(curCurvePos.y, false)
			//10
		);
		*/
...
},{"../../helpers/NavigationMechanics":1,"../../helpers/OrbitalMechanics":2}]},{},[8]);
